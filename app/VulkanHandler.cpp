...
vk::SurfaceFormatKHR VulkanHandler::chooseSwapSurfaceFormat(const std::vector<vk::SurfaceFormatKHR> &availableFormats)
{
...
vk::PresentModeKHR VulkanHandler::chooseSwapPresentMode(const std::vector<vk::PresentModeKHR> &availablePresentModes)
{
...
{
    texture.m_ImageView = createImageView(texture.m_Image, vk::Format::eR8G8B8A8Srgb, vk::ImageAspectFlagBits::eColor,
                                          texture.m_MipLevels);
}
...
void VulkanHandler::createBuffer(vk::DeviceSize size, vk::BufferUsageFlags usage, vk::MemoryPropertyFlags properties,
