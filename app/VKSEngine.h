...
namespace vks_engine
{
        ...
        static constexpr float SCENE_MESH_POSITION_UPPER_BOUND = 10.f;

        static constexpr float SCENE_MESH_POSITION_LOWER_BOUND = -10.f;

        static constexpr float SCENE_MESH_SCALE_UPPER_BOUND = 10.f;

        static constexpr float SCENE_MESH_SCALE_LOWER_BOUND = 0.1f;
